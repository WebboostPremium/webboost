...
export function MascotBody({ className = '' }) {
  return (
    <motion.div
...
/** Mitten gripping the top edge of the search bar */
export function MascotHandLeft({ className = '' }) {
  return (
    <motion.div
...
/** Waving mitten on the right edge */
export function MascotHandRight({ className = '' }) {
  return (
    <motion.div
...
export default function Mascot3D({ size = 'md', className = '' }) {
  const sizes = { sm: 'w-32', md: 'w-44', lg: 'w-56' }
  return (
    <div className={`relative ${sizes[size]} ${className}`}>
      <MascotBody />
      <div className="absolute -left-1 top-14 scale-90"><MascotHandLeft /></div>
      <div className="absolute -right-1 top-10 scale-90"><MascotHandRight /></div>
    </div>
  )
}
