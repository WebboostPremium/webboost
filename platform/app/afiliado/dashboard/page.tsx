...
export default function AffiliateDashboardPage() {
  ...
  const cards = [
    { label: 'Prospectos', value: stats.total, icon: Users },
  ...
  return (
    <div>
      <h1 className="heading-xl text-2xl md:text-3xl text-ink">Panel de afiliado</h1>
      <p className="text-slate-500 mt-2">Gestiona prospectos, seguimientos y comisiones.</p>
      ...
      <div className="grid lg:grid-cols-2 gap-6 mt-8">
        <div className="rounded-2xl bg-white border border-slate-100 p-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="font-bold text-ink">Próximos recordatorios</h2>
